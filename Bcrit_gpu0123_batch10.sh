...
BASE_DUMP_PREFIX="exp/gdn-340M-4K-20B/bsize10.seqlen4096.context4096.warmup1024.update1.steps122070.DDPNoWrapper.Bcrit"
...
for LR in "${LRS[@]}"; do
  ...
  export NGPU=4
  CUDA_VISIBLE_DEVICES=0,1,2,3 NNODE=1 LOG_RANK=0 bash /home/a84400789/flame/train.sh \
