...
BASE_DUMP_PREFIX="exp/gdn-340M-4K-20B/bsize4.ngpu8.gdn1.45B.seqlen4096.context4096.warmup1024.update1.steps762939.DDPNoWrapper.Bcrit"
MODEL_REPO="m-a-p/1.3B-100B-GatedDeltaNet-pure"
TOKENIZER_REPO="m-a-p/1.3B-100B-GatedDeltaNet-pure"
...
for LR in "${LRS[@]}"; do
  ...
  CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 NNODE=1 LOG_RANK=0 bash /home/a84400789/flame/train.sh \
    ...
    --model.tokenizer_path "${TOKENIZER_REPO}" \
